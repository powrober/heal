...
public class BoardController {
	...
	public String boardadminListMethod(@RequestParam("page") int currentPage, Model model) {
		
		int limit = 10;
		ArrayList<BoardList> list = boardService.selectadminBoardList(currentPage, limit);

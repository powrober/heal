...
<c:url var="nlist" value="adminnlist.do">
	<c:param name="page" value="1" />
     ...
     <section class="section breadcrumbs-custom parallax-container context-dark" data-parallax-img="/me/resources/images/swiper1.jpg" >
       <div class="parallax-content">
         <div class="container">
           <p class="heading-1 breadcrumbs-custom-title">회원 리스트</p>
	...
	<div style="text-align: center;">
		<div>
			<h2 style="margin: 20px 0 10px 0;">회원 리스트</h2>
		</div>
	</div>
		...
		<table cellspacing="0" class="boardtype2 th_border my_table" width="1000" style="width: 1800px;" >
			...
			<thead>
				<tr>
					...
					<th style="text-align:center; font-size:15px; font-family:sans-serif; color: black;" scope="col">아이디</th>
					<th style="text-align:center; font-size:15px; font-family:sans-serif; color: black;" scope="col">이름</th>
					<th style="text-align:center; font-size:15px; font-family:sans-serif; color: black;" scope="col">닉네임</th>
					<th style="text-align:center; font-size:15px; font-family:sans-serif; color: black;" scope="col">생년월일</th>
					<th style="text-align:center; font-size:15px; font-family:sans-serif; color: black;" scope="col">성별</th>
					<th style="text-align:center; font-size:15px; font-family:sans-serif; color: black;" scope="col">전화번호</th>
					<th style="text-align:center; font-size:15px; font-family:sans-serif; color: black;" scope="col">이메일</th>
					<th style="text-align:center; font-size:15px; font-family:sans-serif; color: black;" scope="col">주소</th>
					<th style="text-align:center; font-size:15px; font-family:sans-serif; color: black;" scope="col">가입일</th>
            ...
            <tbody>
                <tr>
	                ...
	                <tr>
						<td align="center" width="50"  style="font-size:15px; color: black;">${ m.mid }</td>
						...
						<td align="center" width="80"  style="font-size:15px; color: black;">${ m.birthday }</td>
						...
						<td align="center" width="50"  style="font-size:15px; color: black;">${ m.user_now }</td>
						
						<td align="center" width="50"  style="font-size:15px; color: black;">${ m.user_lv }</td>
						
						<td align="center" width="50"  style="font-size:15px; color: black;">
						
							<c:if test="${ !empty m.etc }"><img src="/me/resources/images/file.png" style="width:20px;"> </c:if>

					...
					<td bgcolor=white>
						<table class="table2">
							...
							<tr>
								...
								<td>
									<label class="">
					 					<input type="radio" name="bstatus" value="Y" checked="checked"> <span class="ico"></span>&emsp;공개&emsp;&emsp;</label>
							 		<label class="">
										<input type="radio" name="bstatus"	value="N"> <span class="ico"></span>&emsp;비공개</label>
								</td>
							</tr>

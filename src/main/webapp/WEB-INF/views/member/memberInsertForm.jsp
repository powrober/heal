										...
										<tbody>
											...
											<tr>
												<th>닉네임<span class="ico">*<span
														class="screen_out">필수항목</span></span></th>
												<td><input type="text" name="nick" label="닉네임"
													placeholder="닉네임을 입력해주세요" required></td>
											</tr>
											
											<tr>
												<th>생년월일<span class="ico">*<span
														class="screen_out">필수항목</span></span></th>
											...
											<tr class="select_sex">
												<th>성별</th>
												<td><label class="">
													<input type="radio" name="gender" value="남자"> <span class="ico"></span>남자</label>
													<label class="">
													<input type="radio" name="gender" value="여자"> <span class="ico"></span>여자</label>
													<label class="checked">
													<input type="radio"	name="gender" value="미선택" checked="checked"> <span	class="ico"></span>선택안함</label>
												</td>
											</tr>
											...
											<tr class="field_phone">
												...
												<td>
													<div class="phone_num">
														<input type="tel" value="" pattern="[0-9]*" name="phone"
